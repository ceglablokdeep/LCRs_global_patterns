...
jpeg("Positive_LCR_coverage_distribution.jpeg",width=28,height=18,units="in",res=300)
par(mar=c(5.1,5.1,5,2.1))
plot(t$Alignment_coverage/20,type='l',col="darkorchid4",lwd=3,ylim=c(0,0.05),xlab="Normalized gene position",ylab="Density",main="Density distribution on normalized gene position in all clades",cex.main=2.5,cex.lab=2,cex.axis=2)
...
jpeg("Positive_LCR_coverage_corrplot.jpeg",width=10,height=11,units="in",res=300)

...
plot(log(norrich$V2),log(norrich$numrep),ylab="log(richness)",xlab="log(number of LCRs)",col="blue3",pch=20,main="log transformed richness of >70% LCRs and number of LCRs across different clades")

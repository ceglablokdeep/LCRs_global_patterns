...
echo 'plot(log(norrich$V2),log(norrich$numrep),ylab="log(richness)",xlab="log(number of LCRs)",col="blue3",pch=20,main="log transformed richness of >70% LCRs and number of sequences across different clades")' >> diversity_richness70.r
...
echo 'plot(log(norrich$numrep),log(norrich$rich),ylab="log(richness)",xlab="log(number of sequences)",col="blue3",pch=20,main="log transformed richness of exact LCRs and number of sequences across different clades")' >> diversity_richness_exact.r
...
echo 'plot(log(finaldf$numrep[finaldf$c==clade]),log(finaldf$rich[finaldf$c==clade]),xlim=c(5,9),ylim=c(4,6),ylab="log(richness)",xlab="log(number of sequences)",col=col13rainbow[1],pch=20,main="log transformed richness of LCRs and number of sequences across different clades")' >> pairwise_richness_specieswise70.r
...
echo 'points(log(finaldf$numrep[finaldf$c==groups[clade]]),log(finaldf$rich[finaldf$c==groups[clade]]),ylab="log(richness)",xlab="log(number of sequences)",col=col13rainbow[clade],pch=20,main="log transformed richness of LCRs and number of sequences across different clades",cex=2)' >> pairwise_richness_specieswise70.r
...
echo 'b=lm(formula = log(finaldf$rich[finaldf$c==groups[clade]]) ~ log(finaldf$numrep[finaldf$c==groups[clade]]), data = finaldf)' >> pairwise_richness_specieswise70.r
echo 'plot(log(finaldf$numrep[finaldf$c==groups[clade]]),log(finaldf$rich[finaldf$c==groups[clade]]),ylab="log(richness)",xlab="log(number of sequences)",col=col13rainbow[clade],pch=20,main=paste("log transformed richness of LCRs and number of sequences in ", groups[clade],sep=""),cex=2)' >> pairwise_richness_specieswise70.r
echo 'abline(b,col=col13rainbow[clade],lty=2,lwd=2)' >> pairwise_richness_specieswise70.r

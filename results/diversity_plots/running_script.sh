...
echo 'boxplot(d,outline=F,main="Shannon diversity of repeats across different clades", xlab="Clades",ylab="Shannon diversity", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2, ylim=c(min(ymin),as.numeric(maxquan)+1+(2*(length(P[P$qvalue<0.05,3])))))' >> pairwise_diversity_specieswise70.r
...
echo 'par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))' >> pairwise_diversity_specieswise70.r
echo 'boxplot(d,outline=F,main="Shannon diversity of repeats across different clades", xlab="Clades",ylab="Shannon diversity", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2)' >> pairwise_diversity_specieswise70.r
echo 'dev.off()' >> pairwise_diversity_specieswise70.r
...
echo 'par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))' >> pairwise_diversity_specieswise70.r
echo 'boxplot(d,outline=F,main="Simpson diversity of repeats across different clades", xlab="Clades",ylab="Simpson diversity", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2, ylim=c(min(ymin),as.numeric(maxquan)+1+(2*(length(P[P$qvalue<0.05,3])))))' >> pairwise_diversity_specieswise70.r
echo 'start=maxquan' >> pairwise_diversity_specieswise70.r
echo 'for ( i in seq(1,len,1)){' >> pairwise_diversity_specieswise70.r
echo 'for (j in seq(2,len,1)){' >> pairwise_diversity_specieswise70.r
echo 'tryCatch({' >> pairwise_diversity_specieswise70.r
...
echo 'par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))' >> pairwise_diversity_specieswise70.r
echo 'boxplot(d,outline=F,main="Simpson diversity of repeats across different clades", xlab="Clades",ylab="Simpson diversity", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2)' >> pairwise_diversity_specieswise70.r
echo 'dev.off()' >> pairwise_diversity_specieswise70.r
...
echo 'boxplot(d,outline=F,main="Richness of repeats across clades", xlab="Clades",ylab="Richness of repeats", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2, ylim=c(min(ymin),as.numeric(maxquan)+1+(2*(length(P[P$qvalue<0.05,3])))))' >> pairwise_richness_specieswise70.r
...
echo 'par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))' >> pairwise_richness_specieswise70.r
echo 'boxplot(d,outline=F,main="Richness of repeats across clades", xlab="Clades",ylab="Richness of repeats", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2)' >> pairwise_richness_specieswise70.r
echo 'dev.off()' >> pairwise_richness_specieswise70.r
...
echo 'par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))' >> pairwise_richness_specieswise70.r
echo 'boxplot(d,outline=F,main="Slope of richness of repeats across clades", xlab="Clades",ylab="Slope of richness of repeats", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2, ylim=c(min(ymin),as.numeric(maxquan)+1+(2*(length(P[P$qvalue<0.05,3])))))' >> pairwise_richness_specieswise70.r
echo 'start=maxquan' >> pairwise_richness_specieswise70.r
echo 'for ( i in seq(1,len,1)){' >> pairwise_richness_specieswise70.r
echo 'for (j in seq(2,len,1)){' >> pairwise_richness_specieswise70.r
echo 'tryCatch({' >> pairwise_richness_specieswise70.r
...
echo 'par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))' >> pairwise_richness_specieswise70.r
echo 'boxplot(d,outline=F,main="Slope of richness of repeats across clades", xlab="Clades",ylab="Slope of richness of repeats", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2)' >> pairwise_richness_specieswise70.r
echo 'dev.off()' >> pairwise_richness_specieswise70.r
...
echo 'plot(log(finaldf$numrep[finaldf$c==clade]),log(finaldf$rich[finaldf$c==clade]),xlim=c(5,9),ylim=c(4,6),ylab="log(richness)",xlab="log(number of sequences)",col=col13rainbow[1],pch=20,main="log transformed richness of repeats and number of sequences across different clades")' >> pairwise_richness_specieswise70.r
...
echo 'points(log(finaldf$numrep[finaldf$c==groups[clade]]),log(finaldf$rich[finaldf$c==groups[clade]]),ylab="log(richness)",xlab="log(number of sequences)",col=col13rainbow[clade],pch=20,main="log transformed richness of repeats and number of sequences across different clades",cex=2)' >> pairwise_richness_specieswise70.r
...
echo 'b=lm(formula = log(finaldf$rich[finaldf$c==groups[clade]]) ~ log(finaldf$numrep[finaldf$c==groups[clade]]), data = finaldf)' >> pairwise_richness_specieswise70.r
echo 'plot(log(finaldf$numrep[finaldf$c==groups[clade]]),log(finaldf$rich[finaldf$c==groups[clade]]),ylab="log(richness)",xlab="log(number of sequences)",col=col13rainbow[clade],pch=20,main=paste("log transformed richness of repeats and number of sequences in ", groups[clade],sep=""),cex=2)' >> pairwise_richness_specieswise70.r
echo 'abline(b,col=col13rainbow[clade],lty=2,lwd=2)' >> pairwise_richness_specieswise70.r

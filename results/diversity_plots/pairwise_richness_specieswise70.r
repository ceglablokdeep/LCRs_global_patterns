...
boxplot(d,outline=F,main="Richness of repeats across clades", xlab="Clades",ylab="Richness of repeats", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2, ylim=c(min(ymin),as.numeric(maxquan)+1+(2*(length(P[P$qvalue<0.05,3])))))
start=maxquan
...
par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))
boxplot(d,outline=F,main="Richness of repeats across clades", xlab="Clades",ylab="Richness of repeats", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2)
dev.off()
...
par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))
boxplot(d,outline=F,main="Slope of richness of repeats across clades", xlab="Clades",ylab="Slope of richness of repeats", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2, ylim=c(min(ymin),as.numeric(maxquan)+1+(2*(length(P[P$qvalue<0.05,3])))))
start=maxquan
for ( i in seq(1,len,1)){
for (j in seq(2,len,1)){
tryCatch({
...
par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))
boxplot(d,outline=F,main="Slope of richness of repeats across clades", xlab="Clades",ylab="Slope of richness of repeats", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2)
dev.off()
...
plot(log(finaldf$numrep[finaldf$c==clade]),log(finaldf$rich[finaldf$c==clade]),xlim=c(5,9),ylim=c(4,6),ylab="log(richness)",xlab="log(number of sequences)",col=col13rainbow[1],pch=20,main="log transformed richness of repeats and number of sequences across different clades")
...
points(log(finaldf$numrep[finaldf$c==groups[clade]]),log(finaldf$rich[finaldf$c==groups[clade]]),ylab="log(richness)",xlab="log(number of sequences)",col=col13rainbow[clade],pch=20,main="log transformed richness of repeats and number of sequences across different clades",cex=2)
...
b=lm(formula = log(finaldf$rich[finaldf$c==groups[clade]]) ~ log(finaldf$numrep[finaldf$c==groups[clade]]), data = finaldf)
plot(log(finaldf$numrep[finaldf$c==groups[clade]]),log(finaldf$rich[finaldf$c==groups[clade]]),ylab="log(richness)",xlab="log(number of sequences)",col=col13rainbow[clade],pch=20,main=paste("log transformed richness of repeats and number of sequences in ", groups[clade],sep=""),cex=2)
abline(b,col=col13rainbow[clade],lty=2,lwd=2)

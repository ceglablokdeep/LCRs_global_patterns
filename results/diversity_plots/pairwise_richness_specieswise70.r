...
plot(log(finaldf$numrep[finaldf$c==clade]),log(finaldf$rich[finaldf$c==clade]),xlim=c(5,9),ylim=c(4,6),ylab="log(richness)",xlab="log(number of sequences)",col=col13rainbow[1],pch=20,main="log transformed richness of LCRs and number of sequences across different clades")
...
points(log(finaldf$numrep[finaldf$c==groups[clade]]),log(finaldf$rich[finaldf$c==groups[clade]]),ylab="log(richness)",xlab="log(number of sequences)",col=col13rainbow[clade],pch=20,main="log transformed richness of LCRs and number of sequences across different clades",cex=2)
...
b=lm(formula = log(finaldf$rich[finaldf$c==groups[clade]]) ~ log(finaldf$numrep[finaldf$c==groups[clade]]), data = finaldf)
plot(log(finaldf$numrep[finaldf$c==groups[clade]]),log(finaldf$rich[finaldf$c==groups[clade]]),ylab="log(richness)",xlab="log(number of sequences)",col=col13rainbow[clade],pch=20,main=paste("log transformed richness of LCRs and number of sequences in ", groups[clade],sep=""),cex=2)
abline(b,col=col13rainbow[clade],lty=2,lwd=2)

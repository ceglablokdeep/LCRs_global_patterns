...
boxplot(d,outline=F,main="Shannon diversity of LCRs across different clades", xlab="Clades",ylab="Shannon diversity", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2, ylim=c(min(ymin),as.numeric(maxquan)+1+(2*(length(P[P$qvalue<0.05,3])))))
start=maxquan
...
par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))
boxplot(d,outline=F,main="Shannon diversity of LCRs across different clades", xlab="Clades",ylab="Shannon diversity", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2)
dev.off()
...
par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))
boxplot(d,outline=F,main="Simpson diversity of LCRs across different clades", xlab="Clades",ylab="Simpson diversity", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2, ylim=c(min(ymin),as.numeric(maxquan)+1+(2*(length(P[P$qvalue<0.05,3])))))
start=maxquan
for ( i in seq(1,len,1)){
for (j in seq(2,len,1)){
tryCatch({
...
par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))
boxplot(d,outline=F,main="Simpson diversity of LCRs across different clades", xlab="Clades",ylab="Simpson diversity", col="Lightsalmon", border="black", las=2, cex=4, cex.main=4, cex.axis=3, cex.lab=4, lwd=2)
dev.off()

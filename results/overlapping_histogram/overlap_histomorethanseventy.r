...
jpeg(paste('overlap_of_lcrmorethanseventy_and_pssites_in_',cname,'_in_all_genes.jpeg',sep=''),width=28,height=18,units="in",res=300)
par(mar=c(6,7,5,2))
mtitle=paste("Distribution of low-complexity regions of > 70 % purity and positively selected sites in",clade,"on normalized gene position",sep=" ")
...
pr1=paste('Low-complexity regions of > 70% purity ( n =',nrp,')')

...
jpeg(paste('overlap_of_cbr_and_pssites_in_',cname,'_in_all_genes.jpeg',sep=''),width=28,height=18,units="in",res=300)
par(mar=c(6,7,5,2))
mtitle=paste("Distribution of compositionally-biased regions and positively selected sites in",clade,"on normalized gene position",sep=" ")

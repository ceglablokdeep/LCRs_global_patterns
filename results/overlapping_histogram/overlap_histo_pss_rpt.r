...
jpeg(paste('overlap_of_bcbr_and_pssites_in_all_genes.jpeg',sep=''),width=28,height=18,units="in",res=300)
par(mar=c(6,7,5,2))
plot(1, type = "n", xlab = "",ylab = "", xlim = xlim, ylim = ylim,main="Distribution of compositionally-biased regions and positively selected sites on normalized gene position",cex.axis=2,cex.main=3,xaxt='n')

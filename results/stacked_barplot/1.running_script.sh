...
sed -i 's/afrotheria/Afrotheria/g' top_twenty_proportion_morethanseventy.txt
sed -i 's/amphibia/Amphibia/g' top_twenty_proportion_morethanseventy.txt
sed -i 's/artiodactyla/Artiodactyla/g' top_twenty_proportion_morethanseventy.txt
sed -i 's/aves/Aves/g' top_twenty_proportion_morethanseventy.txt
sed -i 's/carnivore/Carnivora/g' top_twenty_proportion_morethanseventy.txt
sed -i 's/chiroptera/Chiroptera/g' top_twenty_proportion_morethanseventy.txt
sed -i 's/lagomorpha/Lagomorpha/g' top_twenty_proportion_morethanseventy.txt
sed -i 's/marsupials/Marsupialia/g' top_twenty_proportion_morethanseventy.txt
sed -i 's/perissodactyla/Perissodactyla/g' top_twenty_proportion_morethanseventy.txt
sed -i 's/primates/Primates/g' top_twenty_proportion_morethanseventy.txt
sed -i 's/rodents/Rodentia/g' top_twenty_proportion_morethanseventy.txt
sed -i 's/squamata/Squamata/g' top_twenty_proportion_morethanseventy.txt
sed -i 's/testudines/Testudines/g' top_twenty_proportion_morethanseventy.txt
...
echo 'm1=data.frame(m[,colnames(m)=="Repeats"])' >> top_twenty_proportion.r
echo 'for(cols in c("Afrotheria","Primates","Rodentia","Lagomorpha","Chiroptera","Artiodactyla","Perissodactyla","Carnivora","Marsupialia","Testudines","Aves","Squamata","Amphibia")){' >> top_twenty_proportion.r
echo 'm2=data.frame(m[,colnames(m)==cols])' >> top_twenty_proportion.r
echo 'm1=cbind(m1,m2)}' >> top_twenty_proportion.r
echo 'colnames(m1)=c("Repeats","Afrotheria","Primates","Rodentia","Lagomorpha","Chiroptera","Artiodactyla","Perissodactyla","Carnivora","Marsupialia","Testudines","Aves","Squamata","Amphibia")' >> top_twenty_proportion.r
echo 'm=m1' >> top_twenty_proportion.r
...
echo 'barplot(as.matrix(m),col=col21rainbow,main="Proportion of top 20 >70% LPSs across clades",cex.main=2,xlab="Proportion of LPSs",ylab="",horiz=T,las=2,cex.axis=1.5,cex.lab=2)' >> top_twenty_proportion.r

...
plot(sldf$mid,sldf$normval,ylim=c(0,max(dfp$normval)+10),xlim=c(0,100),type='l',lwd=4,col="black",main=ptitle,xlab="Normalized position in gene",ylab="",cex.main=4,cex.axis=1,cex.lab=1.5)
